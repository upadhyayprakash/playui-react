...
import playUIGitHubPreview from './assets/playui_github_thumbnail.svg';
...
<div className="" align="center" style={{ padding: '2em' }}>
  <a href="https://upadhyayprakash.github.io/playui-react" target="_blank">
    <img src={playUIGitHubPreview} alt="playui-react GitHub Repository Thumbnail" width="640" height="320" />
  </a>
</div>
